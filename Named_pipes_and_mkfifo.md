...
Вы увидите надпись "Nothing happened yet" и процесс приостановит выполнение. Как только вы в соседнем терминале выполните `tail -f /tmp/myfifo`, вы увидете надпись "fifo is opened for writing, waiting 10 sec before writing". На текущем этапе fifo открыт на запись, но операции записи еще не было.
